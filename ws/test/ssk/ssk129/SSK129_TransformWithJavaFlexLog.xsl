...
<xsl:stylesheet 
    ...
    <xsl:param name="int0025XsltLibFlexLogExtensions" as="xs:string" select="ctx:getProperty(tube:getCurrentMediationContext(),'int0025XsltLibFlexLogExtensions')" static="yes"/>
	<!--
	...
	-->
    <!-- <xsl:param name="int0025XsltLibFlexLogExtensions" as="xs:string" select="'file:/C:/Users/john.smail/workspace/ConfigCatalog/INT0025_CheckWorkRights_VisaCheck_Inbound/ws/WSAR-INF/xslt/int0025147/SSK147_FunctionLib_Extensions.xsl'" static="yes"/> -->
    ...
    -->
    <xsl:include _href="{$int0025XsltLibFlexLogExtensions}"/>
