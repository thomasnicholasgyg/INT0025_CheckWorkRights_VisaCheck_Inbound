...
<xsl:stylesheet version="3.0"
           ...
           <soapenv:Body>
              <bsvc:Get_Workers_Request bsvc:version="{$inApiVersion}">
                 ...
                 <bsvc:Response_Filter>
					<bsvc:As_Of_Effective_Date>1970-01-01-08:00</bsvc:As_Of_Effective_Date>
	            	<bsvc:As_Of_Entry_DateTime>1970-01-01T12:00:00.000-08:00</bsvc:As_Of_Entry_DateTime>
    ...
    <xsl:template match="/Map/Entry">
	    <bsvc:Worker_Reference>
	       <bsvc:ID bsvc:type="{./Var[Key eq 'WorkerReferenceIdType']/Value}"><xsl:value-of select="./Var[Key eq 'WorkerReferenceId']/Value"/></bsvc:ID>
	    </bsvc:Worker_Reference>
    </xsl:template>
</xsl:stylesheet>
